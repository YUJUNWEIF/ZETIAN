  ...
  //              break;
	...
	public void UpdateMesh( )
	{
		...
		case SplitMode.BySplineSegment:
			FESplineSegment[] splineSegments = spline.SplineSegments;
			
			splineSegment = Mathf.Clamp( splineSegment, 0, splineSegments.Length-1 );
			
			FESplineSegment segment = splineSegments[splineSegment];
			
			startParam = (float)segment.StartNode.Parameters[spline.impl].position;
