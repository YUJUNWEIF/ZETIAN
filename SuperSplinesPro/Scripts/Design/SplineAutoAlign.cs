...
public class SplineAutoAlign : MonoBehaviour 
{
	...
	public void AutoAlign( )
	{
		...
		foreach( var item in spline.SplineNodes )
		{
			RaycastHit[] raycastHits = Physics.RaycastAll( item.position.V3(), raycastDirection, Mathf.Infinity, raycastLayers );
			...
			item.position = (closestHit.point - raycastDirection * offset).V3();
		}
	}
}
