...
public class UnpackAssets : MonoBehaviour
{
    ...
    static void Unpack()
    {
        string file = EditorUtility.OpenFilePanel("Select assets file to unpack", "", "asset");
        ...
        foreach (Object obj in objs1)
        {
            ...
            if (type == typeof(Material) || (type.IsSubclassOf(typeof(Material)))) { ext = "mat"; }
            else if (type == typeof(AnimationClip) || (type.IsSubclassOf(typeof(AnimationClip)))) { ext = "anim"; }
            else if (type == typeof(GameObject) || (type.IsSubclassOf(typeof(GameObject)))) { ext = "prefab"; }
